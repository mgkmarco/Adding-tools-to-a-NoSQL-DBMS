...
public class QueryCollectionDialog extends javax.swing.JDialog {
    ...
    private void populateQueryAndProjectionDropDown()
    {
        ...
        qryAndProjection.add("Match");
        qryAndProjection.add("Conditional");
    ...
    private void executeQuery()
    {
        try
        {
            ...
            BasicDBObject group = new BasicDBObject("$group", new BasicDBObject("_id", "$name").append("avrage", new BasicDBObject("$sum", 1)));
            BasicDBObject match = new BasicDBObject("$match", new BasicDBObject("name", "Marco"));
            ...
            this.queryEditor.textArea.setText(res);
        }
        catch(Exception e)
        {
            e.getMessage();
...
//        objList.add(new BasicDBObject("name", "Marco"));
//        objList.add(new BasicDBObject("first_name", "Ruth"));
//        objList.add(new BasicDBObject("first_name", "Ruby"));
//        andQuery.put("$or", objList);
//
//        DBCursor dbCursor = collection.find(andQuery).sort(new BasicDBObject("country", -1));
//        String result = "";
//        
...
//        }
//        
//        this.syntaxEditor1.textArea.setText(result);
    }
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(clearButton, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void executeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_executeButtonActionPerformed
        try
        {
            ...
            switch(this.QryType)
            {
                case "Match":
                {       
                    this.outputEditor.textArea.setText(this.groupByPanel.groupByOperation(collection, this));
                    this.queryTabbedPane.setSelectedIndex(1);
                    String query = "FROM " + CollectionName + "\n";
