...
public class Initializations {
    ...
    //Added by Ronald for queries
    public static final String CONDITIONAL_DIALOG_IN_AND_NOT_IN = "Conditional (IN and NOT IN)";
    public static final String IN_SYNTAX = "IN ";
    public static final String NOT_IN_SYNTAX = "NOT IN ";
    public static final String NO_DATA_FOUND = "No records found!";
    public static final String CONDITIONAL_WITH_LIMITED_FIELDS = "Conditional (Limited Fields)";
    public static final String SELECT = "SELECT ";
    public static final String UPDATE_DIALOG = "Update";
    public static final String NO_DOCUMENTS_UPDATED = "No documents have been updated.";
    public static final String MULTIPLE_DOCUMENTS_UPDATED = " documents have been updated successfully.";
    public static final String ONE_DOCUMENT_UPDATED = "1 document has been updated successfully.";
    public static final String UPDATE_SYNTAX = "UPDATE ";
    public static final String SET_SYNTAX = "SET ";
    public static final String SELECT_ALL_SYNTAX = "SELECT * " + "\n";
    public static final String INSERT_DIALOG = "Insert";
    
    //-------------------Added by Ronald-------------------
    //KEYS for the MainForm.java
    ...
    public static final String DBS_POP_UP_MENU_MESSAGE = "Right click on any database in the list to show a Popup Menu with operations (View Users, Add DB, Drop DB, Connect).";
    public static final String NOUSERSEXIST = "No users exist!";
    public static final String NO_DB_SELECTED_ERROR = "No Database Selected";
    public static final String NO_DB_SELECTED_MESSAGE = "Please select a database from the list in order to view it's current users.";
    public static final String USERS_POP_UP_MENU_MESSAGE = "Right click on a user to delete him/her from the database or right click on any user to add another user to the database.";
    
    //KEYS for the MainAppLoginDialog.java
    public static final String LOGIN_MESSAGE = "Log in either as an Administrator to have full access or as a Standard User to have restricted access.";
    public static final String MESSAGE_ADMIN = "You have successfully logged in as an Administrator.";
    public static final String MESSAGE_STANDARD_USER = "You have successfully logged in as a Standard User. ";
    public static final String INCORRECT_CREDENTIALS_MESSAGE = "Incorrect username or password!";
    
    //KEYS for the AddUsersDialog.java
    public static final String BLANK_USERNAME_AND_PASSWORD = "Your username and password must not be blank.";
    public static final String SAME_USER_NAME_AND_PASSWORD = "Your username and password must not be the same.";
    public static final String UNABLE_TO_CREATE_USER = "Unable to create user.";
    public static final String CREATE_USER_ABORTED = "The create user operation has been aborted!";
    public static final String YOU_HAVE_SUCCESSFULLY_ADDED = "You have successfully added ";
